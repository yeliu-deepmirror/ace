"""
    ...
    Modified from https://github.com/RangiLyu/nanodet/blob/main/nanodet/model/backbone/ghostnet.py
"""
import math
import torch
...
def get_url(width_mult=1.0):
    if width_mult == 1.0:
        ...
        logger.info("GhostNet only has 1.0 pretrain model. ")
        return None
...
class ConvBnAct(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, kernel_size, stride=1, act_cfg=None):
        super().__init__()
        if act_cfg is None:
            act_cfg = "ReLU"
...
class GhostModule(nn.Module):
    ...
    def __init__(self, inp, oup, kernel_size=1, ratio=2, dw_size=3, stride=1, act_cfg=None):
        super().__init__()
        self.oup = oup
        if act_cfg is None:
            act_cfg = "ReLU"
        ...
        self.primary_conv = nn.Sequential(
            ...
            act_layers(act_cfg) if act_cfg else nn.Sequential(),
        )
...
class GhostBottleneck(nn.Module):
    ...
    def __init__(self,
        ...
        self.ghost1 = GhostModule(in_chs, mid_chs, act_cfg=act_cfg)
        ...
        self.ghost2 = GhostModule(mid_chs, out_chs, act_cfg=None)
